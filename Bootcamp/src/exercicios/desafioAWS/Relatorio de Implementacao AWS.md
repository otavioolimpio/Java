...
## Introdução
Este relatório apresenta o processo de implementação de ferramentas na empresa Abstergo Industries, realizado por Otávio Olímpio. O objetivo do projeto foi elencar 3 serviços AWS, com a finalidade de realizar diminuição de custos imediatos.
...
Descrição de caso de uso: Uso do Amazon EC2 para hospedar o sistema ERP ou a API responsável pelo controle de vendas, distribuição e logística. Permite que o sistema fique disponível 24/7 para equipes internas, representantes comerciais e integração com transportadoras e fornecedores, além de possibilitar o dimensionamento dos recursos conforme a demanda.



## Conclusão
A implementação das ferramentas na empresa Abstergo Industries tem como esperado alta disponibilidade dos sistemas, escalabilidade da infraestrutura, segurança das informações, redução de custos com servidores físicos, backup automatizado e melhoria no desempenho do controle logístico e de estoque, o que aumentará a eficiência e a produtividade da empresa.
Recomenda-se a continuidade da utilização das ferramentas implementadas e a busca por novas tecnologias que possam melhorar ainda mais os processos da empresa.

Responsável pelo Projeto: Otávio Olímpio